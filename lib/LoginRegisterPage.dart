...
@override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('极简Blog', textAlign: TextAlign.center,),
        actions: <Widget>[
          Container(
  ...
  List<Widget> _createButtons() {
    if(_formType==FormType.login){
      return [
        RaisedButton(
          child: Text('登入', style: TextStyle(fontSize: 20.0),),
        ...
        FlatButton(
          child: Text('没有账号?创建新账号...', style: TextStyle(fontSize: 14.0),),
      ...
      return [
        ...
        FlatButton(
          child: Text('已有账号?登录...', style: TextStyle(fontSize: 14.0),),
          textColor: Colors.red,
          color: Colors.white,
